...
const FALLBACK_RELEASE: AppRelease = {
  ...
  channel: "stable",
  version: "0.3.0",
  downloadUrl: "https://d36v39m4b0nmuu.cloudfront.net/releases/MarkVas%20Setup%200.3.0.exe",
  releaseNotes: "에셋 동기화 안정성 개선: 비활성화·삭제 시 테마 즉시 해제, 동기화 로딩 표시 수정, 라이브러리 삭제 후 재설치 방지.",
  checksum: "",
  signature: undefined,
